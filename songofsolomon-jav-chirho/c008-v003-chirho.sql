...
-- SONGOFSOLOMON c8-v3 - JAV
-- Astanipun–kiwa ing–sangandhap mustaka–kula lan–astanipun–tengen ngrangkul–kula
...
-- 2200800302: תַּ֣חַת (H8478) → "ing–sangandhap" [opus-4.5-chirho]
WITH np AS (
  INSERT INTO phrase (language_id, created_at)
  SELECT (SELECT id FROM language WHERE code = 'jav'), NOW()
  WHERE NOT EXISTS (
