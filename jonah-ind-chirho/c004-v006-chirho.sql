...
-- JONAH c4-v6 - IND
-- Dan–menyediakanlah TUHAN– Allah pohon–jarak dan–ia–tumbuh di–atas Yunus untuk–menjadi naungan di–atas– kepalanya, untuk–menyelamatkan dia dari–kesusahannya; dan–bersukacitalah Yunus karena– pohon–jarak sukacita yang–besar.
