...
-- Na–walikuwa wana–wa– Yerahmeeli mzaliwa–wa–kwanza–wa Hesroni –mzaliwa–wa–kwanza Ramu na–Buna na–Oreni na–Osemu Ahiya

BEGIN;
-- 1300202501: וַיִּהְי֧וּ (H1961) → "Na–walikuwa" [opus-4.5-chirho]
WITH np AS (
