...
-- JUDE c1-v7 - CES
-- jako Sodoma a Gomora a –ta kolem nich města –tím podobným způsobem jako–oni smilnivší a odešedší za tělem jiným jsou–vystavena jako–příklad ohně věčného trest snášejíce
