...
-- NAHUM - IND Combined
-- Generated: 2026-01-29T22:32:16.185Z

-- c003-v001: Celakalah kota pertumpahan–darah! Semuanya dusta, perampokan penuh, tidak berhenti mangsa.
-- c003-v002: Suara cambuk dan–suara gemertak roda, dan–kuda berlari–kencang, dan–kereta melompat-lompat.
-- c003-v003: Penunggang–kuda naik, dan–nyala pedang dan–kilat tombak, dan–banyak yang–terbunuh dan–berat mayat; dan–tidak–ada akhir untuk–tubuh-tubuh, [mereka–tersandung] (dan–tersandung) atas–tubuh-tubuh–mereka.
-- c003-v004: Karena–banyak perzinaan pelacur, cantik dan–penuh–pesona, ahli ilmu–sihir, yang–menjual bangsa-bangsa dengan–perzinaannya, dan–kaum-kaum dengan–ilmu–sihirnya.
-- c003-v005: Lihatlah,–Aku menentangmu, demikianlah–firman TUHAN semesta–alam, dan–Aku–akan–menyingkap kainmu di–atas– mukamu, dan–Aku–akan–memperlihatkan bangsa-bangsa ketelanjanganmu, dan–kerajaan-kerajaan kehinaanmu.
-- c003-v006: Dan–Aku–akan–melemparkan ke–atasmu kekejian-kekejian, dan–Aku–akan–menistakan–engkau, dan–Aku–akan–menjadikan–engkau tontonan.
-- c003-v007: Dan–akan–terjadi semua– yang–melihatmu akan–menyingkir darimu, dan–akan–berkata, Hancur Niniwe, siapa berbelas–kasihan kepadanya? Dari–mana akan–kucari penghibur-penghibur bagimu?
-- c003-v008: Apakah–lebih–baik–engkau dari–No– Amon yang–duduk di–sungai-sungai–Nil, air di–sekelilingnya itu, yang– benteng laut, dari–laut temboknya?
-- c003-v009: Kush kekuatannya dan–Mesir, dan–tidak–ada batas; Put dan–Libya adalah dalam–bantuanmu.
-- c003-v010: Juga– dia untuk–pembuangan pergi dalam–penawanan, juga anak-anaknya dihancurkan di–kepala setiap– persimpangan–jalan; dan–untuk– orang-orang–terhormatnya mereka–membuang undi, dan–semua– pembesar-pembesarnya diikat dengan–rantai.
-- c003-v011: Juga– engkau akan–mabuk, engkau–akan–menjadi tersembunyi; juga– engkau akan–mencari perlindungan dari–musuh.
-- c003-v012: Semua– benteng-bentengmu pohon–ara dengan– buah–sulung; jika– mereka–diguncang, dan–jatuh ke– mulut yang–makan.
-- c003-v013: Lihatlah, bangsamu perempuan-perempuan di–tengah-tengahmu; kepada–musuh-musuhmu terbuka terbuka–lebar pintu-pintu–gerbang negerimu; memakan api palang-palangmu.
-- c003-v014: Air pengepungan timbalkanlah– bagimu, kuatkanlah benteng-bentengmu; masuklah ke–dalam–lumpur, dan–injaklah di–dalam–tanah–liat, peganglah cetakan–batu–bata.
-- c003-v015: Di–sana akan–memakanmu api, akan–melenyapkanmu pedang, akan–memakanmu seperti–belalang–pelompat; perbanyaklah–dirimu seperti–belalang–pelompat, perbanyaklah–dirimu seperti–belalang–pindahan.
-- c003-v016: Engkau–memperbanyak pedagang-pedagangmu lebih–dari–bintang-bintang langit; belalang–pelompat mengupas dan–terbang.
-- c003-v017: Penjaga-penjagamu seperti–belalang–pindahan, dan–para–panglimamu seperti–kawanan belalang yang–berkemah di–pagar-pagar pada–hari dingin; matahari terbit dan–ia–melarikan–diri, dan–tidak– diketahui tempatnya, di–mana–mereka?
-- c003-v018: Tertidur gembala-gembalamu, raja Asyur, bertempat–tinggal pembesar-pembesarmu; terserak rakyatmu di–atas– gunung-gunung dan–tidak–ada yang–mengumpulkan.
-- c003-v019: Tidak–ada– penyembuhan bagi–patahmu, menyakitkan lukamu; semua yang–mendengar beritamu bertepuk tangan tentangmu, sebab atas– siapa tidak– melewati kejahatanmu terus-menerus?
