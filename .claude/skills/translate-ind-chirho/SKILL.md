---
name: translate-ind-chirho
description: Indonesian (Bahasa Indonesia) Bible translation skill. Use when translating into Indonesian. Includes Malay-based conventions and affixation patterns.
---
...
# Indonesian (Bahasa Indonesia) Translation Skill

## Script: Latin

Standard Latin alphabet without diacritics.

## Divine Names

| Original | Indonesian | Notes |
|----------|------------|-------|
| יהוה (YHWH) | TUHAN / Yahweh | LORD or Yahweh |
| אלהים (Elohim) | Allah | God |
| אדני (Adonai) | Tuhan | Lord |
| Χριστός | Kristus | Christ |
| Ἰησοῦς | Yesus | Jesus |
| Κύριος | Tuhan | Lord |
| Θεός | Allah | God |

## Proper Names (Greek → Indonesian)

| Greek | Indonesian | Notes |
|-------|------------|-------|
| Ἰούδας | Yudas | Judas/Jude |
| Ἰάκωβος | Yakobus | James |
| Πέτρος | Petrus | Peter |
| Παῦλος | Paulus | Paul |
| Μωϋσῆς | Musa | Moses |
| Ἀβραάμ | Abraham | Abraham |
| Δαυίδ | Daud | David |

## Particle Conventions

Indonesian uses affixes and function words:
- dari (from)
- kepada (to)
- dalam (in)
- di atas (on/upon)

For bound Greek/Hebrew morphemes, use n-dash or natural Indonesian.
...
2. **Affixation**: Productive
   - me-/-kan (transitive verb)
   - ber- (intransitive/stative)
   - ke-/-an (noun/adjective)

3. **No Tense Marking**: Time words
   - sudah (already/past)
   - sedang (now/progressive)
   - akan (will/future)

4. **No Gender/Case**: Simple noun system
...
2. Maintain consistency with Indonesian Bible tradition (TB/LAI)
3. Clear, formal register
...
- **Proverbs 1-15**: Complete (451 verses, ~2943 words) - Wisdom's Call, Trust in the LORD, Father's Instruction
...
- 2026-01: Added Proverbs chapters 1-15 (451 verses) - Wisdom's Call, Trust in TUHAN, Warnings Against Folly
